print('='*10,"TOKO MAS YANN",'='*10)
print('Kami Sedang Ada Promo tahun baru')
total = 0
barang = []
harga = []
...
diskon = 0
promo = input("Masukkan Kode Promo : ")
if promo == "MINGGUPROMO":
    diskon = total * 5/100
elif promo == "BIGDISKONTHBARU":
    diskon = total * 10/100
else:
    print("Kode Invalid")
...
print("total yang harus dibayar :", total1)
